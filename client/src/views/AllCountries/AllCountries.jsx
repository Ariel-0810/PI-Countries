...
const AllCountries = () => {
    ...
    const indexOfLastCountry = currentPage * countriesPerPage //? calculo el índice del último país que debe aparecer en la página actual. Para la primera página, este valor es "10" 
